...
<html>
  ...
  <h3><span class="btn btn-primary"><b><i>NEC</i> Project Exibition 2016 Voting Center</b></span></h3>
      ...
      <div class="login-box-body">
        ...
        <form action="" method="post">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
                <input type="submit" value="Log In" class="btn btn-primary btn-block btn-flat" name="login"/>
            </div><!-- /.col -->
          </div>
        </form>
        <a href="<?php echo LINK_URL?>user/forgotPassword">I forgot my password</a><br>
