...
<html>
  <head>
    ...
    <title>NEC Project Exibition 2016</title>
    <link rel="icon" type="image/png" href="<?php echo PUBLIC_URL;?>necLogo.PNG"/>
  ...
  <body class="">
    <div class="wrapper">
      ...
      <header class="headerNec">
        <!-- Logo -->
        <a href="<?php echo LINK_URL?>voting/index" class="logo">
