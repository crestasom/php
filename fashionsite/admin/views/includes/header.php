  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="<?php echo LINK_URL?>site/index" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>A</b>LT</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>E-Nepal</b> Admin Panel</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              <li class="dropdown user user-menu"><li class="user-footer">
                    <div class="pull-left">
                        <a href="<?php echo LINK_URL?>user/changePassword/<?php echo $_SESSION['memId']?>" class="btn btn-default btn-primary">Change Password </a>
                    </div>
                    <div class="pull-right">
                        <a href="<?php echo LINK_URL?>site/logout" class="btn btn-default btn-success">log out</a>
                    </div>
                  </li>
                </ul>
              </li>
