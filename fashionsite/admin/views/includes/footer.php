      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 E-Nepal.</strong> All rights reserved.
      </footer>
    ...
    <script src="<?php echo PUBLIC_URL?>plugins/morris/morris.min.js"></script>
    <!-- Sparkline -->
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo PUBLIC_URL?>dist/js/app.min.js"></script>
