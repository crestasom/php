<section id="article-section" class="line archive">
         <div class="margin">
            ...
            <div class="s-12 l-9">
               ...
               <article class="margin-bottom">
                  <div class="post-1 line">
                     ...
                     <div class="s-12 l-11 post-image">                   
                        <a href="post-1.html"><img src="<?php echo PUBLIC_URL; ?>img/post1-big.jpg" alt="Fashion"></a>              
                     </div>
                     <!-- date -->                 
               ...
               <article class="margin-bottom">
                  <div class="post-2 line">
                     <!-- image -->                 
                     <div class="s-12 l-11 post-image">                   
                        <a href="post-2.html"><img src="<?php echo PUBLIC_URL; ?>img/post2-big.jpg" alt="Fashion"></a>              
                     </div>
                     <!-- date -->                 
                     <div class="s-12 l-1 post-date">
                        <p class="date">06</p>
               ...
               <article class="margin-bottom">
                  <div class="post-3 line">
                     <!-- image -->                 
                     <div class="s-12 l-11 post-image">                   
                        <a href="post-3.html"><img src="<?php echo PUBLIC_URL; ?>img/post3-big.jpg" alt="Fashion"></a>              
                     </div>
                     <!-- date -->                 
                     <div class="s-12 l-1 post-date">
                        <p class="date">04</p>
               ...
               <article class="margin-bottom">
                  <div class="post-4 line">
                     <!-- image -->                 
                     <div class="s-12 l-11 post-image">                   
                        <a href="post-4.html"><img src="<?php echo PUBLIC_URL; ?>img/post4-big.jpg" alt="Fashion"></a>              
                     </div>
                     <!-- date -->                 
                     <div class="s-12 l-1 post-date">
                        <p class="date">01</p>
            ...
            <div class="s-12 l-3">
               <aside>
                  <!-- NEWS 1 -->           
                  <img src="<?php echo PUBLIC_URL; ?>img/news1.jpg" alt="News 1">          
                  ...
                  <div class="advertising margin-bottom">
                     <img src="<?php echo PUBLIC_URL; ?>img/banner.jpg" alt="ad banner">          
                  </div>
                  <!-- NEWS 2 -->           
                  <img src="<?php echo PUBLIC_URL; ?>img/news2.jpg" alt="News 2">          
                  <div class="aside-block margin-bottom">
